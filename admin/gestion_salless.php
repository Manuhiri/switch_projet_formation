...
if( isset($_GET['action']) && $_GET['action'] == 'suppression' ){
    ...
    $chemin_photo_a_supprimer = str_replace( "http://localhost", $_SERVER['DOCUMENT_ROOT'], $article_a_supprimer['photo'] );
...
if( !empty( $_POST) ){
    ...
    if ( !empty($_FILES['photo']['name'] ) ){
            ...
            $photo_dossier = $_SERVER['DOCUMENT_ROOT'] . "/manuhirilr908/photo/$nom_photo";
